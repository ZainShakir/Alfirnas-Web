    ...
    try {
      const response = await axios.get(
        `https://api.mapbox.com/geocoding/v5/mapbox.places/${longitude.toString()},${latitude.toString()}.json?country=sa&language=ar`,
        {
          params: {
            access_token:
              'sk.eyJ1IjoiemFpbjIwMjQiLCJhIjoiY2xtYzM1bXp2MDFoMTNrbnpmanMxeXYxOSJ9.Eu8H1HladlY5BRqSILG3Fg',
          },
        }
      );
        ...
        <div className="content">
          <div className="content__grid">
            ...
            <div
              ...
              style={{ display: uploadMethod === 'upload' ? 'block' : 'none' }}
            >
            ...
            <div
              className="col-12-m8"
              id="urlContainer"
              style={{ display: uploadMethod === 'url' ? 'block' : 'none' }}
            >
              <label className="input__label" htmlFor="file">
                Enter Image URL
              </label>
            ...
            <div className="col-12 content__grid" id="imageOptions">
              <div className="col-12-s6-m4" id="labels">
                ...
                <div>
                  <button
                    type="button"
                    data-value="off"
                    className={`bttn left ${label === 'Off' ? 'active' : ''}`}
                    onClick={() => handleLabelClick('Off')}
                  >
                    Off
                  </button>
                  <button
                    data-value="on"
                    type="button"
                    className={`bttn right ${label === 'On' ? 'active' : ''}`}
                    onClick={() => handleLabelClick('On')}
                  >
                    On
                  </button>
                </div>
              ...
              <div className="col-12-s6-m4" id="stroke">
                ...
                <div>
                  <button
                    data-value="1"
                    onClick={() => handleStrokeClick('1')}
                    type="button"
                    className={`bttn left ${
                      strokeWidth === '1' ? 'active' : ''
                    }`}
                  >
                    1px
                  </button>
                  <button
                    data-value="2"
                    onClick={() => handleStrokeClick('2')}
                    type="button"
                    className={`bttn ${strokeWidth === '2' ? 'active' : ''}`}
                  >
                    2px
                  </button>
                  <button
                    data-value="5"
                    onClick={() => handleStrokeClick('5')}
                    type="button"
                    className={`bttn ${strokeWidth === '5' ? 'active' : ''}`}
                  >
                    5px
                  </button>
                  <button
                    data-value="10"
                    onClick={() => handleStrokeClick('10')}
                    type="button"
                    className={`bttn right ${
                      strokeWidth === '10' ? 'active' : ''
                    }`}
                  >
                    10px
                  </button>
